...
barcodeList=pd.read_csv("/hpcnfs/scratch/temporary/Dav_vc/0.2_SynthII_creation/SYNTH5/Synth_Balanced_noDoublets/Barcodes-IDs.tsv", header= None , sep = "\t", names = ["Barcode","ID"])
targetDblRatio=0.1
inputBam="/hpcnfs/scratch/temporary/Dav_vc/0.2_SynthII_creation/SYNTH5/Synth_Balanced_noDoublets/SilicoMultiplexed.bam"
outfile="/hpcnfs/scratch/temporary/Dav_vc/0.2_SynthII_creation/SYNTH5/Synth_Balanced_doublets/SilicoMultiplexed.dblAdded.bam"
nThreads=10
WD=os.getcwd()+'/'
TEMPDIR=WD+'tempdir/'
