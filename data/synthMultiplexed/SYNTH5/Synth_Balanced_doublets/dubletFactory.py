...
barcodeList=pd.read_csv("/SYNTH5/Synth_Balanced_noDoublets/Barcodes-IDs.tsv", header= None , sep = "\t", names = ["Barcode","ID"])
targetDblRatio=0.1
inputBam="/SYNTH5/Synth_Balanced_noDoublets/SilicoMultiplexed.bam"
outfile="/SYNTH5/Synth_Balanced_doublets/SilicoMultiplexed.dblAdded.bam"
nThreads=10
WD=os.getcwd()+'/'
TEMPDIR=WD+'tempdir/'
